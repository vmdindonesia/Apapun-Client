...
export class CrafterInputResiPage extends React.Component {
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={{ flex: 1, width: '100%', backgroundColor: '#fff', marginTop: 5, padding: 10 }}>
                        ...
                        <Text style={{ fontFamily: 'Quicksand-Regular', fontSize: 13, textAlign: 'center' }}>Silahkan melakukan pengiriman dan masukan nomor resi pada kolom dibawah ini</Text>
                        <Input
                         />
                        <TouchableOpacity style={{ width: '100%', height: 40, borderRadius: 15, backgroundColor: 'black', justifyContent: 'center', marginTop: 10 }}>
                            <Text style={{ color: 'white', fontFamily: 'Quicksand-Bold', fontSize: 13, textAlign: 'center' }}>Proses</Text>
                        </TouchableOpacity>
                    </View>
...
export default CrafterInputResiPage;