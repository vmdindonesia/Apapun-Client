...
import { MyOrderCngPage } from './myOrderCng';
import { CrafterPage } from './crafter';
import Icon from 'react-native-vector-icons/Ionicons';
import axios from 'axios';
import { IPSERVER } from './../shared/config';

export class FindingCrafterCngPage extends React.Component {
  ...
  renderScreen = () => {
    if (this.state.screen === 'myOrderCng') {
      return <MyOrderCngPage navi={this.props.navigation} />
      ...
      <View style={menuContainerStyle}>
        <View style={{ flexDirection: 'row' }}>
          <View style={{ flex: 1, backgroundColor: 'white' }}>
            <TouchableNativeFeedback onPress={() => this.setState({ screen: 'myOrderCng' })}>
...
export default FindingCrafterCngPage;