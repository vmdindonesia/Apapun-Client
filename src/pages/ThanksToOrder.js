            ...
            <View style={{
                ...
                <ScrollView style={{
                    ...
                    <View style={{ width: '100%', height: 220, marginTop: 12.5, backgroundColor: 'white', alignItems: 'center' }}>
                        ...
                        <View style={{ width: '89%', height: '100%', backgroundColor: 'white', justifyContent: 'center', alignContent: 'center' }}>
                            <Text style={{ fontFamily: 'Quicksand-Bold', fontSize: 15, color: 'black', textAlign: 'center' }}>TERIMA KASIH ATAS KERJA KERASNYA</Text>
                            <Text style={{ fontFamily: 'Quicksand-Regular', fontSize: 15, color: 'black', textAlign: 'center', paddingTop: 5 }}>Silakan menunggu hasil review buyer mengenai produk Anda</Text>
                        </View>
